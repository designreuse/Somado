...
public class Settings extends HashMap<String, String> implements IData {
  ...
  public void loadBasic() throws FileNotFoundException, SettingsException  {
    ...
    try {
      props.load(Settings.class.getResourceAsStream("/resources/conf.properties"));
    } catch (IOException ex) {
      System.err.println(Settings.class.getResource("/resources/conf.properties").getFile());
