...
public class MapPanel extends JXMapKit {  
  ...
  public void setRoute(List<RoutePoint> routePoints) {
    ...
    while (iterator.hasNext()) {
      ...
      if (point.getOrder() != null) 
        wpPainters.add(new WaypointLabelPainter<>(new DefaultWaypoint(new GeoPosition(point.getOrder().getCustomer().getLatitude(),
  ...
  public void setFinalRoute(List<DeliveryDriverOrder> routePoints) {
    ...
    while (iterator.hasNext()) {
      ...
      wpPainters.add(new WaypointLabelPainter<>(new DefaultWaypoint(new GeoPosition(point.getCustomerLatitude(),
